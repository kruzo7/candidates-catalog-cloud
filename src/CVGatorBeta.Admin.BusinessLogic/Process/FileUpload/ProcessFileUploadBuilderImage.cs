...
{
    public class ProcessFileUploadBuilderImage : IProcessFileUploadBuilder
    {
        ...
        public ProcessFileUploadBuilderImage(
        ...
        public async Task Validate()
        {
            ...
            var validators = _validatorFactory.GetValidatorsImage();
