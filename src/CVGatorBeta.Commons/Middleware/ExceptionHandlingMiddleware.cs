...
namespace CVGatorBeta.Commons.Middleware
{
    /// <summary>
        ...
        public async Task Invoke(FunctionContext context, FunctionExecutionDelegate next)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (httpReqData != null)
                {
                    ...
                    await newHttpResponse.WriteAsJsonAsync(new { Status = "Invocation failed!", Error = ex.Message }, newHttpResponse.StatusCode);
